...
const smsLista1 = () => { return `🌟 معلومات EMPERORANUS-BOT 🌟`}
...
const smsLista7 = () => { return `🐈 تثبيت EMPERORANUSBot-BOT 🐈`}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 ممتاز EMPERORANUSBot-MD - WhatsApp '}
...
//_antispam.js
const smsNoSpam = () => { return `🤨 لا تزعجني ، فلن تكون قادرًا على الاستخدام ${global.packname} إلى عن على ${60000 / 1000 - 59} اللحظة`}
...
const smsModP2 = () => { return `تمكين الوظيفة حتى يتمكن الجميع من استخدام YunaBot`}
const smsModAd1 = () => { return `🛂 وضع المشرف`}
const smsModAd2 = () => { return `سيتمكن المسؤولون فقط من استخدام YunaBot في المجموعات`}
