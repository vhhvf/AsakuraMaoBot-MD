...
let vn = './media/a.mp3'
const estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "967771160204-771160204@g.us" } : {}) },
message: { 
...
const estiloaudio = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "967771160204-771160204@g.us" } : {}) },
message: { 
